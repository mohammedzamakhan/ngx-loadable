...
const FAQ = [
  {
    question:
      'When does the <code>ngx-loadable</code> component trigger download of the module',
    answer:
      'The module loading will be postponed until the <code>show</code> input has a truthy value passed to the <ngx-loadable> component.'
  },
  {
    question:
      'What will happen if I use same module multiple times in single template?',
    answer:
      'The module will be downloaded only once!'
  },
  {
    question:
      'When do we need to use <code>isElement</code> flag?',
    answer:
