...
export function addPackageJsonDependency(tree: Tree, dependency: NodeDependency, projectPath?: string): void {
...
function _readPackageJson(tree: Tree, projectPath?: string): JsonAstObject {
